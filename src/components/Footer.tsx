const Footer = () => {
  const columns = [
    {
      title: "Services",
      links: ["Web Development", "Automation for Business", "Open Source", "Content creation"],
    },
    {
      title: "Resources",
      links: ["Blog", "Resume", "GitHub"],
    },
    {
      title: "Connect",
      links: ["Instagram", "LinkedIn", "GitHub", "Email"],
    },
  ];
    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-16">
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-xs">© 2026 VasanthDev. All rights reserved.</p>
